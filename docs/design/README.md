...
`value-flow-versioning-policy.md` is live policy; every other document below is historical and describes the pre-carve monorepo.

## Contents

- `value-flow-versioning-policy.md`: the post-1.0 versioning policy for `videre:value-flow` (live, tracker issue #31).
...
Each historical document carries a provenance header.
